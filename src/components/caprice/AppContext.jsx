...
import { hero, heroSlides } from '@/lib/caprice';
...
export default function AppContext({children}){
  ...
  useEffect(()=>{const onboards=[hero,'https://media.base44.com/images/public/6a93174580eda443a786e6c3/7770644eb_generated_image.png','https://media.base44.com/images/public/6a93174580eda443a786e6c3/281f9526f_generated_image.png'];const staticP=Promise.all([hero,...onboards,...heroSlides].map(preloadImage));base44.entities.Product.list().then(p=>{setProducts(p);Promise.all([preloadProducts(p),staticP]).then(()=>setImagesReady(true))}).finally(()=>setLoading(false))},[]);
